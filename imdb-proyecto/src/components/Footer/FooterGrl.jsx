...
export function Footer() {
    const noDeployMsj = (e) => {
        e.preventDefault();
        alert("🚧 El porfolio todavía no está deployado.")
    }
    ...
    return(
        <>
            <footer className="footer">
                    ...
                    <a href="https://manuelleguizamon.vercel.app/" target="_blank" rel="noopener noreferrer" className='m-3'><i className="bi bi-briefcase fs-3 icon-footer"></i></a> 
